...
model = keras.applications.inception_v3.InceptionV3(weights=None, input_shape=(299, 299, 3))
...
x_train = x_train[0:args.batch_size]
y_train = y_train[0:args.batch_size]

data_upscaled = np.zeros((args.batch_size, 299, 299, 3))
