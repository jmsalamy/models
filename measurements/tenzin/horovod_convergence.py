...
#model = keras.applications.vgg16.VGG16(weights=None, input_shape=(32, 32, 3), include_top=True, classes=10)
#model = keras.applications.resnet50.ResNet50(weights=None, input_shape=(32, 32, 3), include_top=True, classes=10)
#model = keras.applications.VGG19(weights=None, input_shape=(32, 32, 3), include_top=True, classes=10)
...
hooks = [
    ...
    keras.callbacks.EarlyStopping(monitor='val_loss', min_delta=0, patience=10, verbose=1, mode='auto', baseline=None, restore_best_weights=True),
]
